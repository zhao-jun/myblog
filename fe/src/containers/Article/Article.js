...
/*    commentDelete(id) {
        const{_alert,commentDelete}  = this.props.actions;
        commentDelete(id);
    }*/
                        ...
                        <ul>
                            {
                                articleBoxData.comments.map((comment,index)=>(
                                    <div key={index} className="comment-item" ref={ref=>{this.commentItem=ref}}>
                                        <div className="left">
                                            <img className="avatar" src={avatar} />
                                        ...
                                        <div className="main">
                                            ...
                                            <p className="info">
                                                ...
                                                <span className="delete" onClick={()=>{actions.commentDelete(comment._id);this.commentItem.style.display="none"}} style={{display:(comment.author.name==loginBoxData.name || loginBoxData.name == "admin")?"block":"none"}}>删除</span>
                                            </p>
                                        </div>
